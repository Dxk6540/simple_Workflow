...
/************ Test 2: action flow container test **********
* 
*
*
*/
...
actionflowContainer flowContainer;
...
/************ Step5: config the action flow before you are going to start it ***********/
  ...
  flowContainer.addActionFlow(&flowTest2);
  flowContainer.addActionFlow(&flowTest);
...
// return 1 means successful
  ...
  if(ret == 1){
    ...
    testFSM.changeStateWorkflow(&flowContainer);    
  }
...
/************ Test 1: simple action flow test **********
* 
*
*
*/
